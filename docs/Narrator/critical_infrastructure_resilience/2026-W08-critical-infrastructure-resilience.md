---
layout: report
title: "2026-W08 Critical Infrastructure Resilience"
...
seo:
  ...
  faq:
    ...
    - question: "OT 安全團隊需要注意哪些新要求？"
      answer: "NIST SP 1334 可攜式儲存媒體 OT 安全指引（draft）建議 ICS 管理員建立 USB 裝置管理標準。NCCoE IoT 安全接入最終出版物要求在 IoT 設備連網前建立信任機制。Transit Cybersecurity Framework Community Profile 徵求公眾意見中。"
    - question: "歐盟 EuroHPC 修正案有何影響？"
      answer: "Council Regulation (EU) 2026/150 將 EuroHPC Joint Undertaking 擴展至 AI Gigafactories 與量子運算，新增建立與營運大規模 AI 基礎設施、授予 EuroHPC AI and Compute Infrastructure Seal 等職責，強化歐盟 AI 技術主權。"
---
...
<table class="comparison-table">
  ...
  <tbody>
    <tr>
      <td>能源</td>
      <td>無新要求</td>
      <td>能源社群反詐欺合作、環境法規整合、能源效率指令修正</td>
      <td>Council Decision (EU) 2026/69, 2026/70; Directive (EU) 2025/2647</td>
    </tr>
    <tr>
      <td>電信</td>
      <td>無新要求</td>
    ...
    <tr>
      ...
      <td>無新要求</td>
      <td>NIST CSWP 51 持續徵詢</td>
    </tr>
    <tr>
      <td>水務</td>
      <td>無新要求</td>
      <td>飲用水指令技術勘誤</td>
      <td>Directive (EU) 2020/2184 Corrigendum</td>
    </tr>
  </tbody>
</table>
