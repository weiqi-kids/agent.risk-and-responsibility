#!/bin/bash
# nist_cybersecurity_insights 資料更新腳本
...
# 確保分類子目錄存在
for category in cybersecurity ai_risk privacy supply_chain identity critical_infrastructure workforce policy_guidance; do
