...
- **純活動宣傳**：僅宣傳活動而無實質技術/政策內容
- **節日/紀念性文章**：僅為節日慶祝而無框架/政策實質內容

### 過濾判定方法

1. **標題關鍵字快篩**：若 title 含以下關鍵字，判定為跳過：
   - `Staff Stories`, `Spotlight Series`, `Q&A with`
2. **內容性質判定**：若文章主要為個人經歷分享、職涯故事，而非政策分析或技術指引，應跳過
...
- 政策趨勢觀察
- 技術指引與最佳實踐
- 人才教育計畫的實質內容（如 NICE Framework 更新）
